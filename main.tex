...
\begin{frame}{Bewertung}
    ...
    \alt<1> {
        \begin{figure}[H]
            \centering
            \includegraphics[width=\textwidth]{basisfallnot.png}
            \caption{Basisfall n = 1}
        \end{figure}
    }{
        \begin{figure}[H]
            \centering
            \includegraphics[width=\textwidth]{basisfallmod.png}
...
\begin{frame}{Ausblick}
    ...
    \qquad $\rightharpoonup$ Matrizen vergrößern auf $2^k \times 2^k$
    
    \qquad $\rightharpoonup$ Basisfall modifizieren
    \bigskip
    
    $\rightarrow$ Modifikation des Algorithmus notwendig (Basisfall)
    \bigskip
